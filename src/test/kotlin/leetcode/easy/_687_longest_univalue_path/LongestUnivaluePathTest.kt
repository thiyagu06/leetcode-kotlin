...
class LongestUnivaluePathTest {
    ...
    private val bigInput = buildTree(
    ...
    fun longestUnivaluePath() {
        ...
        assertEquals(3, solution.longestUnivaluePath(buildTree(4, 4, 4, 4, 4)))
        assertEquals(4, solution.longestUnivaluePath(buildTree(1, 1, 1, 1, 7, 1, 3)))
        assertEquals(6, solution.longestUnivaluePath(buildTree(1, 1, 1, null, null, 1, 1, null, null, 1, 7, 1, 3, null, null, 1)))
        assertEquals(6, solution.longestUnivaluePath(buildTree(4, 4, 4, 4, 4, null, null, null, null, null, 4, null, 4, null, 4)))
    }

    @Test
    fun longestUnivaluePathBigInput() {
        assertEquals(2, solution.longestUnivaluePath(bigInput))
    }

    @Test
    fun longestUnivaluePath2() {
        assertEquals(0, solution2.longestUnivaluePath(null))
        ...
        assertEquals(3, solution2.longestUnivaluePath(buildTree(4, 4, 4, 4, 4)))
        assertEquals(4, solution2.longestUnivaluePath(buildTree(1, 1, 1, 1, 7, 1, 3)))
        assertEquals(6, solution2.longestUnivaluePath(buildTree(1, 1, 1, null, null, 1, 1, null, null, 1, 7, 1, 3, null, null, 1)))
        assertEquals(5, solution2.longestUnivaluePath(buildTree(4, 4, null, 4, 4, null, null, null, 4, null, 4, null, 4)))
        assertEquals(6, solution2.longestUnivaluePath(buildTree(4, 4, 4, 4, 4, null, null, null, null, null, 4, null, 4, null, 4)))
    }

    @Test
    fun longestUnivaluePathBigInput2() {
        assertEquals(2, solution2.longestUnivaluePath(bigInput))
    }


    @Test
    fun longestUnivaluePath3() {
        assertEquals(0, solution3.longestUnivaluePath(null))
        assertEquals(0, solution3.longestUnivaluePath(tree123))
        assertEquals(0, solution3.longestUnivaluePath(tree1to5))
        assertEquals(0, solution3.longestUnivaluePath(bst3LevelsFull))
        assertEquals(0, solution3.longestUnivaluePath(bstWithNulls))
        assertEquals(0, solution3.longestUnivaluePath(buildTree(1)))
        assertEquals(1, solution3.longestUnivaluePath(buildTree(1, 1)))
        assertEquals(1, solution3.longestUnivaluePath(buildTree(1, null, 1)))
        assertEquals(2, solution3.longestUnivaluePath(buildTree(5, 4, 5, 1, 1, 5)))
        assertEquals(2, solution3.longestUnivaluePath(buildTree(1, 4, 5, 4, 4, 5)))
        assertEquals(2, solution3.longestUnivaluePath(buildTree(1, 1, 1)))
        assertEquals(3, solution3.longestUnivaluePath(buildTree(1, 1, 1, 1)))
        assertEquals(2, solution3.longestUnivaluePath(treeUnbalanced))
        assertEquals(10, solution3.longestUnivaluePath(treeUnbalanced2))
        assertEquals(3, solution3.longestUnivaluePath(buildTree(4, 4, 4, 4, 4)))
        assertEquals(4, solution3.longestUnivaluePath(buildTree(1, 1, 1, 1, 7, 1, 3)))
        assertEquals(6, solution3.longestUnivaluePath(buildTree(1, 1, 1, null, null, 1, 1, null, null, 1, 7, 1, 3, null, null, 1)))
        assertEquals(5, solution3.longestUnivaluePath(buildTree(4, 4, null, 4, 4, null, null, null, 4, null, 4, null, 4)))
        assertEquals(6, solution3.longestUnivaluePath(buildTree(4, 4, 4, 4, 4, null, null, null, null, null, 4, null, 4, null, 4)))
    }

    @Test
    fun longestUnivaluePathBigInput3() {
        assertEquals(2, solution3.longestUnivaluePath(bigInput))
    }
}