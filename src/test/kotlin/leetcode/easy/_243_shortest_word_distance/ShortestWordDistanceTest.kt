...
class ShortestWordDistanceTest {
    ...
    fun shortestDistance() {
        ...
        assertEquals(3, solution.shortestDistance(
            words = words,
            word1 = "coding",
            word2 = "practice"
        ))

        assertEquals(1, solution.shortestDistance(
            words = words,
            word1 = "makes",
            word2 = "coding"
        ))
    ...
    fun shortestDistance2() {
        val words = arrayOf("practice", "makes", "perfect", "coding", "makes")
        assertEquals(3, solution2.shortestDistance(
            words = words,
            word1 = "coding",
            word2 = "practice"
        ))

        assertEquals(1, solution2.shortestDistance(
            words = words,
            word1 = "makes",
            word2 = "coding"
        ))
