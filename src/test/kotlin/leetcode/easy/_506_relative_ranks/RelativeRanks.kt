...
class RelativeRanks {
    ...
    fun findRelativeRanks() {
        ...
        assertArrayEquals(
            arrayOf("Silver Medal", "Gold Medal"),
        ...
        assertArrayEquals(
            arrayOf("Gold Medal", "Bronze Medal", "4", "5", "Silver Medal"),
            solution.findRelativeRanks(intArrayOf(5, 3, 2, 1, 4))
        )
        assertArrayEquals(
            arrayOf("Silver Medal", "Bronze Medal", "4", "5", "6", "Gold Medal"),
            solution.findRelativeRanks(intArrayOf(5, 4, 3, 2, 1, 6))
        )
        assertArrayEquals(
            arrayOf("5", "4", "Bronze Medal", "Silver Medal", "Gold Medal"),
