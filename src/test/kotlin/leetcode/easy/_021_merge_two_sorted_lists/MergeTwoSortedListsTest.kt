...
class MergeTwoSortedListsTest {
    ...
    fun mergeTwoLists() {
        ...
        assertEquals(
            linkedListOf(1, 1, 2, 3, 4, 4),
            solution.mergeTwoLists(linkedListOf(1, 2, 4), linkedListOf(1, 3, 4))
        )
        assertEquals(
            linkedListOf(1, 1, 2, 3, 4, 4, 5),
            solution.mergeTwoLists(linkedListOf(1, 2, 4), linkedListOf(1, 3, 4, 5))
        )
    }
}